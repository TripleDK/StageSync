...
import com.example.mtapp.exercises.InventoryTopAppBar
...
import com.example.mtapp.ui.examples.item.formattedPrice
...
@Composable
fun HomeBody(
    itemList: List<Item>, onItemClick: (Int) -> Unit,
    modifier: Modifier = Modifier
) {
    Column(
...
private fun InventoryList(
    itemList: List<Item>, onItemClick: (Item) -> Unit, modifier: Modifier
) {
