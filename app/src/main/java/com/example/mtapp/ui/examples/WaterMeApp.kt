...
import com.example.mtapp.FIVE_SECONDS
import com.example.mtapp.Models.exercises.Plant
import com.example.mtapp.ONE_DAY
...
fun PlantListItemPreview() {
    MTAPPTheme {
        PlantListItem(WaterMeDataSource.plants[0], {})
    }
}
...
fun PlantListContentPreview() {
    PlantListContent(plants = WaterMeDataSource.plants, onScheduleReminder = {})
}